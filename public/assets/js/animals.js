...
const getAnimals = (formData = {}) => {
  ...
  // make the request using queryUrl 11.3.7
  ...
  .then(animalData => {
    ...
    // send our array of animal data to the printResults() function, where it generates cards for each animal and prints them to the page!
